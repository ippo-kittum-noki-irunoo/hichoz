...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('𝐶𝐿𝐼𝐶𝐾 𝐻𝐸𝑅𝐸 𝐹𝑂𝑅 𝑀𝑂𝑅𝐸 𝐵𝑈𝑇𝑇𝑂𝑁𝑆', callback_data='unda')
            ],[
            InlineKeyboardButton(' 𝐿𝐸Ø', url='t.me/Leo_V4Bot?start')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❉CHᗩNNEL❉', url='https://t.me/+hpnKBqJC_cQ3ZjU1'),
        ...
        buttons= [[
            ...
            InlineKeyboardButton('EXPAND🦋', callback_data='5')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▰▱▱▱▱▱▱▱▱▱ 10%"
...
async def advantage_spell_chok(msg):
    ...
    btn = [[
        InlineKeyboardButton('CAM PRINT', url='https://t.me/+0i9k0q9Uv4RkMTg1')
        ]]
    btn.append([InlineKeyboardButton('🔍ɢᴏᴏɢʟᴇ🔎', url=f'https://www.google.com/search?q=')])
    await msg.reply("**𝖡𝗋𝗈, 𝖢𝗁𝖾𝖼𝗄 𝗍𝗁𝖾 𝗌𝗉𝖾𝗅𝗅𝗂𝗇𝗀 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗌𝖾𝗇𝖽 𝗂𝗇 𝗀𝗈𝗈𝗀𝗅𝖾. 𝖨𝖿 𝖸𝗈𝗎 𝗁𝖺𝗏𝖾 𝗋𝖾𝗊𝗎𝖾𝗌𝗍𝖾𝖽 𝖥𝗈𝗋 𝖢𝖺𝗆 𝗉𝗋𝗂𝗇𝗍 𝖸𝗈𝗎 𝗐𝗂𝗅𝗅 𝗇𝗈𝗍 𝖦𝖾𝗍 𝗂𝗍. if you want join this channel**",
                    reply_markup=InlineKeyboardMarkup(btn))
